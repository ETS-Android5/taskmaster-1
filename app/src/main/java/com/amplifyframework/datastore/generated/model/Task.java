...
public final class Task implements Model {
  ...
  private Task(String id, String name, String body, Temporal.DateTime dateCreated, State State, String taskImageS3Key, Team team) {
    this.id = id;
    this.name = name;
    this.body = body;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String body, Temporal.DateTime dateCreated, State state, String taskImageS3Key, Team team) {
      super.id(id);
      super.name(name)
        .body(body)
