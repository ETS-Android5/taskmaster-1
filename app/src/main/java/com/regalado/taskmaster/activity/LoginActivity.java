...
public class LoginActivity extends AppCompatActivity {
    ...
    public void handleLogin()
    {
        ...
        Button loginButton = (Button) findViewById(R.id.buttonLoginLoginActivity);
        loginButton.setOnClickListener(v ->
        {
            String username = usernameEditText.getText().toString();
            String password = ((EditText) findViewById(R.id.editTextPasswordLoginActivity)).getText().toString();
        ...
        Button signUpButton = (Button) findViewById(R.id.buttonSignupLoginActivity);
