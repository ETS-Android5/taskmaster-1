...
## Lab 42: Monetization and AdMob

## Daily Change Log 4/18 and 4/23

- added google play services ads dependency
- updated meta-data tag in `AndroidManifest.xml`   
- initialized ads in mainActivity
- added interstitial and reward ads buttons on `mainActivity`
- added ads to `mainActivity.xml`
- wired up interstitial and reward ad functionality on `mainActivity`
- displayed reward points and type in text view on `mainActivity`
